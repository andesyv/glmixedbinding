...
const std::unordered_map<std::string, GLextension> Meta_ExtensionsByString_A =
{
    ...
    { "GL_ANGLE_depth_texture", GLextension::GL_ANGLE_depth_texture },
    { "GL_ANGLE_framebuffer_blit", GLextension::GL_ANGLE_framebuffer_blit },
    { "GL_ANGLE_framebuffer_multisample", GLextension::GL_ANGLE_framebuffer_multisample },
    { "GL_ANGLE_instanced_arrays", GLextension::GL_ANGLE_instanced_arrays },
    { "GL_ANGLE_pack_reverse_row_order", GLextension::GL_ANGLE_pack_reverse_row_order },
    { "GL_ANGLE_program_binary", GLextension::GL_ANGLE_program_binary },
    { "GL_ANGLE_texture_compression_dxt3", GLextension::GL_ANGLE_texture_compression_dxt3 },
    { "GL_ANGLE_texture_compression_dxt5", GLextension::GL_ANGLE_texture_compression_dxt5 },
    { "GL_ANGLE_texture_usage", GLextension::GL_ANGLE_texture_usage },
    { "GL_ANGLE_translated_shader_source", GLextension::GL_ANGLE_translated_shader_source },
    ...
    { "GL_APPLE_clip_distance", GLextension::GL_APPLE_clip_distance },
    { "GL_APPLE_color_buffer_packed_float", GLextension::GL_APPLE_color_buffer_packed_float },
    { "GL_APPLE_copy_texture_levels", GLextension::GL_APPLE_copy_texture_levels },
    ...
    { "GL_APPLE_framebuffer_multisample", GLextension::GL_APPLE_framebuffer_multisample },
    ...
    { "GL_APPLE_sync", GLextension::GL_APPLE_sync },
    { "GL_APPLE_texture_format_BGRA8888", GLextension::GL_APPLE_texture_format_BGRA8888 },
    { "GL_APPLE_texture_max_level", GLextension::GL_APPLE_texture_max_level },
    { "GL_APPLE_texture_packed_float", GLextension::GL_APPLE_texture_packed_float },
...
{
    { "GL_DMP_program_binary", GLextension::GL_DMP_program_binary },
    { "GL_DMP_shader_binary", GLextension::GL_DMP_shader_binary }
};
...
const std::unordered_map<std::string, GLextension> Meta_ExtensionsByString_E =
{
    ...
    { "GL_EXT_buffer_storage", GLextension::GL_EXT_buffer_storage },
    { "GL_EXT_clear_texture", GLextension::GL_EXT_clear_texture },
    { "GL_EXT_clip_control", GLextension::GL_EXT_clip_control },
    { "GL_EXT_clip_cull_distance", GLextension::GL_EXT_clip_cull_distance },
    { "GL_EXT_clip_volume_hint", GLextension::GL_EXT_clip_volume_hint },
    { "GL_EXT_cmyka", GLextension::GL_EXT_cmyka },
    { "GL_EXT_color_buffer_float", GLextension::GL_EXT_color_buffer_float },
    { "GL_EXT_color_buffer_half_float", GLextension::GL_EXT_color_buffer_half_float },
    ...
    { "GL_EXT_conservative_depth", GLextension::GL_EXT_conservative_depth },
    ...
    { "GL_EXT_draw_buffers_indexed", GLextension::GL_EXT_draw_buffers_indexed },
    ...
    { "GL_EXT_EGL_image_storage_compression", GLextension::GL_EXT_EGL_image_storage_compression },
    ...
    { "GL_EXT_fragment_shading_rate", GLextension::GL_EXT_fragment_shading_rate },
    ...
    { "GL_EXT_geometry_shader", GLextension::GL_EXT_geometry_shader },
    ...
    { "GL_EXT_gpu_shader5", GLextension::GL_EXT_gpu_shader5 },
    ...
    { "GL_EXT_instanced_arrays", GLextension::GL_EXT_instanced_arrays },
    { "GL_EXT_light_texture", GLextension::GL_EXT_light_texture },
    { "GL_EXT_map_buffer_range", GLextension::GL_EXT_map_buffer_range },
    ...
    { "GL_EXT_multi_draw_indirect", GLextension::GL_EXT_multi_draw_indirect },
    ...
    { "GL_EXT_multisampled_render_to_texture2", GLextension::GL_EXT_multisampled_render_to_texture2 },
    ...
    { "GL_EXT_primitive_bounding_box", GLextension::GL_EXT_primitive_bounding_box },
    { "GL_EXT_protected_textures", GLextension::GL_EXT_protected_textures },
    { "GL_EXT_provoking_vertex", GLextension::GL_EXT_provoking_vertex },
    { "GL_EXT_pvrtc_sRGB", GLextension::GL_EXT_pvrtc_sRGB },
    ...
    { "GL_EXT_separate_depth_stencil", GLextension::GL_EXT_separate_depth_stencil },
    ...
    { "GL_EXT_shader_group_vote", GLextension::GL_EXT_shader_group_vote },
    ...
    { "GL_EXT_shader_implicit_conversions", GLextension::GL_EXT_shader_implicit_conversions },
    { "GL_EXT_shader_integer_mix", GLextension::GL_EXT_shader_integer_mix },
    { "GL_EXT_shader_io_blocks", GLextension::GL_EXT_shader_io_blocks },
    { "GL_EXT_shader_non_constant_global_initializers", GLextension::GL_EXT_shader_non_constant_global_initializers },
    { "GL_EXT_shader_pixel_local_storage", GLextension::GL_EXT_shader_pixel_local_storage },
    { "GL_EXT_shader_pixel_local_storage2", GLextension::GL_EXT_shader_pixel_local_storage2 },
    { "GL_EXT_shader_samples_identical", GLextension::GL_EXT_shader_samples_identical },
    { "GL_EXT_shader_texture_lod", GLextension::GL_EXT_shader_texture_lod },
    ...
    { "GL_EXT_texture_buffer", GLextension::GL_EXT_texture_buffer },
    { "GL_EXT_texture_buffer_object", GLextension::GL_EXT_texture_buffer_object },
    { "GL_EXT_texture_compression_astc_decode_mode", GLextension::GL_EXT_texture_compression_astc_decode_mode },
    { "GL_EXT_texture_compression_bptc", GLextension::GL_EXT_texture_compression_bptc },
    { "GL_EXT_texture_compression_dxt1", GLextension::GL_EXT_texture_compression_dxt1 },
    ...
    { "GL_EXT_texture_compression_s3tc_srgb", GLextension::GL_EXT_texture_compression_s3tc_srgb },
    { "GL_EXT_texture_cube_map", GLextension::GL_EXT_texture_cube_map },
    { "GL_EXT_texture_cube_map_array", GLextension::GL_EXT_texture_cube_map_array },
    ...
    { "GL_EXT_texture_format_BGRA8888", GLextension::GL_EXT_texture_format_BGRA8888 },
    ...
    { "GL_EXT_texture_storage_compression", GLextension::GL_EXT_texture_storage_compression },
...
{
    { "GL_FJ_shader_binary_GCCSO", GLextension::GL_FJ_shader_binary_GCCSO }
};
...
const std::unordered_map<std::string, GLextension> Meta_ExtensionsByString_I =
{
    ...
    { "GL_IMG_bindless_texture", GLextension::GL_IMG_bindless_texture },
    { "GL_IMG_framebuffer_downsample", GLextension::GL_IMG_framebuffer_downsample },
    { "GL_IMG_multisampled_render_to_texture", GLextension::GL_IMG_multisampled_render_to_texture },
    { "GL_IMG_program_binary", GLextension::GL_IMG_program_binary },
    { "GL_IMG_read_format", GLextension::GL_IMG_read_format },
    { "GL_IMG_shader_binary", GLextension::GL_IMG_shader_binary },
    { "GL_IMG_texture_compression_pvrtc", GLextension::GL_IMG_texture_compression_pvrtc },
    { "GL_IMG_texture_compression_pvrtc2", GLextension::GL_IMG_texture_compression_pvrtc2 },
    { "GL_IMG_texture_filter_cubic", GLextension::GL_IMG_texture_filter_cubic },
...
{
    { "GL_MESA_bgra", GLextension::GL_MESA_bgra },
...
const std::unordered_map<std::string, GLextension> Meta_ExtensionsByString_N =
{
    ...
    { "GL_NV_depth_nonlinear", GLextension::GL_NV_depth_nonlinear },
    { "GL_NV_draw_buffers", GLextension::GL_NV_draw_buffers },
    { "GL_NV_draw_instanced", GLextension::GL_NV_draw_instanced },
    ...
    { "GL_NV_explicit_attrib_location", GLextension::GL_NV_explicit_attrib_location },
    { "GL_NV_explicit_multisample", GLextension::GL_NV_explicit_multisample },
    { "GL_NV_fbo_color_attachments", GLextension::GL_NV_fbo_color_attachments },
    ...
    { "GL_NV_framebuffer_multisample", GLextension::GL_NV_framebuffer_multisample },
    { "GL_NV_framebuffer_multisample_coverage", GLextension::GL_NV_framebuffer_multisample_coverage },
    { "GL_NV_generate_mipmap_sRGB", GLextension::GL_NV_generate_mipmap_sRGB },
    ...
    { "GL_NV_memory_object_sparse", GLextension::GL_NV_memory_object_sparse },
    ...
    { "GL_NV_pack_subimage", GLextension::GL_NV_pack_subimage },
    ...
    { "GL_NVX_gpu_multicast2", GLextension::GL_NVX_gpu_multicast2 },
    { "GL_NVX_linked_gpu_multicast", GLextension::GL_NVX_linked_gpu_multicast },
    { "GL_NVX_progress_fence", GLextension::GL_NVX_progress_fence }
};
...
const std::unordered_map<std::string, GLextension> Meta_ExtensionsByString_O =
{
    ...
    { "GL_OES_copy_image", GLextension::GL_OES_copy_image },
    { "GL_OES_depth24", GLextension::GL_OES_depth24 },
    { "GL_OES_depth32", GLextension::GL_OES_depth32 },
    ...
    { "GL_OES_geometry_point_size", GLextension::GL_OES_geometry_point_size },
    { "GL_OES_geometry_shader", GLextension::GL_OES_geometry_shader },
    { "GL_OES_get_program_binary", GLextension::GL_OES_get_program_binary },
    { "GL_OES_gpu_shader5", GLextension::GL_OES_gpu_shader5 },
    { "GL_OES_mapbuffer", GLextension::GL_OES_mapbuffer },
    { "GL_OES_packed_depth_stencil", GLextension::GL_OES_packed_depth_stencil },
    { "GL_OES_primitive_bounding_box", GLextension::GL_OES_primitive_bounding_box },
    { "GL_OES_query_matrix", GLextension::GL_OES_query_matrix },
    { "GL_OES_read_format", GLextension::GL_OES_read_format },
    { "GL_OES_required_internalformat", GLextension::GL_OES_required_internalformat },
    { "GL_OES_rgb8_rgba8", GLextension::GL_OES_rgb8_rgba8 },
    { "GL_OES_sample_shading", GLextension::GL_OES_sample_shading },
    { "GL_OES_sample_variables", GLextension::GL_OES_sample_variables },
    { "GL_OES_shader_image_atomic", GLextension::GL_OES_shader_image_atomic },
    { "GL_OES_shader_io_blocks", GLextension::GL_OES_shader_io_blocks },
    { "GL_OES_shader_multisample_interpolation", GLextension::GL_OES_shader_multisample_interpolation },
    { "GL_OES_single_precision", GLextension::GL_OES_single_precision },
    { "GL_OES_standard_derivatives", GLextension::GL_OES_standard_derivatives },
    { "GL_OES_stencil1", GLextension::GL_OES_stencil1 },
    { "GL_OES_stencil4", GLextension::GL_OES_stencil4 },
    { "GL_OES_surfaceless_context", GLextension::GL_OES_surfaceless_context },
    { "GL_OES_tessellation_point_size", GLextension::GL_OES_tessellation_point_size },
    { "GL_OES_tessellation_shader", GLextension::GL_OES_tessellation_shader },
    { "GL_OES_texture_3D", GLextension::GL_OES_texture_3D },
    { "GL_OES_texture_border_clamp", GLextension::GL_OES_texture_border_clamp },
    { "GL_OES_texture_buffer", GLextension::GL_OES_texture_buffer },
    { "GL_OES_texture_compression_astc", GLextension::GL_OES_texture_compression_astc },
    { "GL_OES_texture_cube_map_array", GLextension::GL_OES_texture_cube_map_array },
    { "GL_OES_texture_float", GLextension::GL_OES_texture_float },
    { "GL_OES_texture_float_linear", GLextension::GL_OES_texture_float_linear },
    { "GL_OES_texture_half_float", GLextension::GL_OES_texture_half_float },
    { "GL_OES_texture_half_float_linear", GLextension::GL_OES_texture_half_float_linear },
    { "GL_OES_texture_npot", GLextension::GL_OES_texture_npot },
    { "GL_OES_texture_stencil8", GLextension::GL_OES_texture_stencil8 },
    { "GL_OES_texture_storage_multisample_2d_array", GLextension::GL_OES_texture_storage_multisample_2d_array },
    { "GL_OES_texture_view", GLextension::GL_OES_texture_view },
    { "GL_OES_vertex_array_object", GLextension::GL_OES_vertex_array_object },
    { "GL_OES_vertex_half_float", GLextension::GL_OES_vertex_half_float },
    { "GL_OES_vertex_type_10_10_10_2", GLextension::GL_OES_vertex_type_10_10_10_2 },
    { "GL_OES_viewport_array", GLextension::GL_OES_viewport_array },
    ...
    { "GL_OVR_multiview_multisampled_render_to_texture", GLextension::GL_OVR_multiview_multisampled_render_to_texture }
};
...
const std::unordered_map<std::string, GLextension> Meta_ExtensionsByString_Q =
{
    ...
    { "GL_QCOM_extended_get", GLextension::GL_QCOM_extended_get },
    { "GL_QCOM_extended_get2", GLextension::GL_QCOM_extended_get2 },
    { "GL_QCOM_frame_extrapolation", GLextension::GL_QCOM_frame_extrapolation },
    { "GL_QCOM_framebuffer_foveated", GLextension::GL_QCOM_framebuffer_foveated },
    { "GL_QCOM_motion_estimation", GLextension::GL_QCOM_motion_estimation },
    { "GL_QCOM_perfmon_global_mode", GLextension::GL_QCOM_perfmon_global_mode },
    { "GL_QCOM_render_shared_exponent", GLextension::GL_QCOM_render_shared_exponent },
    { "GL_QCOM_render_sRGB_R8_RG8", GLextension::GL_QCOM_render_sRGB_R8_RG8 },
    ...
    { "GL_QCOM_shading_rate", GLextension::GL_QCOM_shading_rate },
    { "GL_QCOM_texture_foveated", GLextension::GL_QCOM_texture_foveated },
    { "GL_QCOM_texture_foveated2", GLextension::GL_QCOM_texture_foveated2 },
...
const std::array<std::unordered_map<std::string, glmixed::GLextension>, 27> Meta_ExtensionsByStringMaps =
{ {
