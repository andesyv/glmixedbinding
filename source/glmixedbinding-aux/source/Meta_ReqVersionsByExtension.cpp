...
const std::unordered_map<GLextension, Version> Meta_ReqVersionsByExtension =
{
    ...
    { GLextension::GL_ARB_imaging, { 1, 4 } },
    ...
    { GLextension::GL_ARB_robustness, { 4, 5 } },
    ...
    { GLextension::GL_ARB_shader_bit_encoding, { 3, 3 } },
    ...
    { GLextension::GL_ARB_shading_language_packing, { 4, 2 } },
    ...
    { GLextension::GL_KHR_context_flush_control, { 4, 6 } },
    { GLextension::GL_KHR_debug, { 4, 3 } },
