...
#include <glmixedbinding-aux/RingBuffer.h>
...
using FunctionCallBuffer = glmixedbinding::aux::RingBuffer<glmixedbinding::aux::LogEntry>;
...
std::ostream & operator<<(std::ostream & stream, const glmixedbinding::FunctionCall * call)
{
...
{
    glmixedbinding::setLogCallback(glmixedbinding::aux::log);
    glmixedbinding::addCallbackMask(CallbackMask::Timestamp | CallbackMask::Logging);
...
{
    glmixedbinding::addCallbackMaskExcept(CallbackMask::Timestamp | CallbackMask::Logging, blackList);
    startWriter(filepath);
}

void stop()
{
    glmixedbinding::removeCallbackMask(CallbackMask::Timestamp | CallbackMask::Logging);
