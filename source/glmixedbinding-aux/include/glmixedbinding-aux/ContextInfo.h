 ...
 *   @TODO: Context info needs to distinguish between multiple APIs.
*/
class GLMIXEDBINDING_AUX_API ContextInfo
{
public:
    /**
    *  @brief
    ...
    *    The list of available extensions known by glbinding
    */
    static std::set<glmixed::GLextension> extensions(std::set<std::string> & unknown);
    ...
    */
    static bool supported(const std::set<glmixed::GLextension> & extensions);
    ...
    *    `true` if all given extensions are supported by the current context, else `false`
    */
    static bool supported(const std::set<glmixed::GLextension> & extensions , std::set<glmixed::GLextension> & unsupported);
