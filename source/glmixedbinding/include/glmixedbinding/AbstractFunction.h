...
*/
class GLMIXEDBINDING_API AbstractFunction
{
...
public:
    ...
    *
    *  @param[in] name
    *    The actual exported OpenGL API function name, including the 'glmixed' prefix
    */
...
protected:
    const char * m_name; ///< The function name, including the 'glmixed' prefix
};
