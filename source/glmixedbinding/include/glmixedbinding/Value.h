...
*/
template <typename T>
class GLMIXEDBINDING_TEMPLATE_API Value : public AbstractValue
{
public:
    /**
    *  @brief
    ...
    */
    GLMIXEDBINDING_CONSTEXPR inline Value(const T & value);
    ...
    *    The value
    */
    GLMIXEDBINDING_CONSTEXPR inline T value() const;
...
#include <glmixedbinding/Value.inl>