...
*/
GLMIXEDBINDING_CONSTEXPR inline CallbackMask operator~(CallbackMask a);
...
*/
GLMIXEDBINDING_CONSTEXPR inline CallbackMask operator|(CallbackMask a, CallbackMask b);
...
#include <glmixedbinding/CallbackMask.inl>