...
*  @endcode
*/
class GLMIXEDBINDING_TEMPLATE_API Version
{
public:
    /**
    *  @brief
    ...
    */
    GLMIXEDBINDING_CONSTEXPR inline Version();
    ...
    *    The minor version
    */
    GLMIXEDBINDING_CONSTEXPR inline Version(unsigned char majorVersion, unsigned char minorVersion);
    ...
    */
    GLMIXEDBINDING_CONSTEXPR inline Version(const Version & version);
    ...
    *    The major version
    */
    GLMIXEDBINDING_CONSTEXPR inline unsigned char majorVersion() const;
    ...
    *    The minor version
    */
    GLMIXEDBINDING_CONSTEXPR inline unsigned char minorVersion() const;
    ...
    */
    GLMIXEDBINDING_CONSTEXPR inline bool isNull() const;
    ...
    */
    GLMIXEDBINDING_CONSTEXPR inline bool operator<(const Version & version) const;
...
#include <glmixedbinding/Version.inl>