...
*/
template <typename ReturnType, typename... Arguments>
struct GLMIXEDBINDING_TEMPLATE_API CallbackType
{
...
struct GLMIXEDBINDING_TEMPLATE_API CallbackType<void, Arguments...>
{
...
*/
template <typename ReturnType, typename... Arguments>
class GLMIXEDBINDING_TEMPLATE_API Function : public AbstractFunction
{
public:
