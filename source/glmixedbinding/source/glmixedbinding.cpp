...
void initialize(glmixedbinding::GetProcAddress functionPointerResolver, bool resolveFunctions)
{
    Binding::initialize(functionPointerResolver, resolveFunctions);
}

void initialize(ContextHandle context, glmixedbinding::GetProcAddress functionPointerResolver, bool useContext, bool resolveFunctions)
{
