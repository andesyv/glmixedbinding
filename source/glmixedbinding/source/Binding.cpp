...
void Binding::initialize(const glmixedbinding::GetProcAddress functionPointerResolver, const bool resolveFunctions)
{
...
,   const glmixedbinding::GetProcAddress functionPointerResolver
...
int & Binding::s_pos()
{
    GLMIXEDBINDING_THREAD_LOCAL int pos = 0;
    //static int pos = 0;
...
{
    GLMIXEDBINDING_THREAD_LOCAL ContextHandle context = 0;
    //static ContextHandle context = 0;

    return context;
}

glmixedbinding::GetProcAddress & Binding::s_getProcAddress()
{
    GLMIXEDBINDING_THREAD_LOCAL glmixedbinding::GetProcAddress getProcAddress = nullptr;
    //static glmixedbinding::GetProcAddress getProcAddress = nullptr;
...
glmixedbinding::GetProcAddress & Binding::s_firstGetProcAddress()
{
    static glmixedbinding::GetProcAddress getProcAddress = nullptr;
