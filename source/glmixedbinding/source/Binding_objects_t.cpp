...
Function<void, GLuint, GLuint, GLuint> Binding::TexEstimateMotionQCOM("glTexEstimateMotionQCOM");
Function<void, GLuint, GLuint, GLuint, GLuint> Binding::TexEstimateMotionRegionsQCOM("glTexEstimateMotionRegionsQCOM");
...
Function<void, GLenum, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLuint, GLuint64, GLboolean> Binding::TexPageCommitmentMemNV("glTexPageCommitmentMemNV");
...
Function<void, GLenum, GLsizei, GLenum, GLsizei, GLsizei, const GLint*> Binding::TexStorageAttribs2DEXT("glTexStorageAttribs2DEXT");
Function<void, GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLsizei, const GLint*> Binding::TexStorageAttribs3DEXT("glTexStorageAttribs3DEXT");
